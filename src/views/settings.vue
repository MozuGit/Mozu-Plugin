        ...
        <div v-if="!loading && !enabled" class="setting-body">
          ...
          <div v-else class="pending-area">
            ...
            <div class="enable-area">
              <a-form layout="inline" @finish="handleEnable">
                <a-form-item>
                  <a-input v-model:value="token" placeholder="6 位验证码" maxlength="6" size="large" class="token-input">
                    <template #prefix>
                      <SafetyOutlined />
                    </template>
                  </a-input>
