...
import { YamlReader } from '../../../Config/YamlReader.js'
...
class Cfg {
  constructor() {
    ...
    this.dirCfgPath = `${Version.Plugin_Path}/config/xiuxian/config`
    this.defCfgPath = `${Version.Plugin_Path}/config/xiuxian/default`
